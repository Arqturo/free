          ...
          <tbody role="rowgroup">
            {solicitudesData?.map((solicitud, index) => (
              <tr key={index} role="row">
                ...
                <td data-label="Monto Slc" role="cell">{solicitud.Monto_Solicitado?.toFixed(2)}</td>
                <td data-label="Monto Pres" role="cell">{solicitud.Monto_Prestamo?.toFixed(2)}</td>
                <td data-label="Descripcion" role="cell">{solicitud.Descripcion}</td>
                <td data-label="Cuotas" role="cell">{solicitud.Numero_Cuotas}</td>
